...
--local brightness_widget = require("brightness.brightness")
local brightness_widget = require("brightness.brightnessarc")
local battery_widget_feature = require("battery.batteryarc")
local brightness_widget_feature = require("brightness.brightnessarc")
...
beautiful.init(gears.filesystem.get_configuration__dir() .. "/themes/default/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
	    ...
	    wibox.widget.textbox(' | '),
        battery_widget_feature({arc_thickness = 3,
...
awful.key({ }, "XF86AudioMute",function () awful.util.spawn("amixer set Master toggle")end, {description = "toggle volume", group = "hotkeys"}), 
    ...
    awful.key({ }, "XF86MonBrightnessUp", function () awful.spawn("xbacklight -inc  5")end,{description = "brightness up", group = "hotkeys"}), 
    awful.key({ }, "XF86MonBrightnessDown", function () awful.spawn("xbacklight -dec 5")end,{description = "brightness down", group = "hotkeys"}),
    ...
    awful.key({ modkey,           }, "c",     function () awful.spawn("chromium")          end,
              {description = "open chromium", group = "application"}),

    awful.key({ modkey,           }, "f",     function () awful.spawn(file_explorer)          end,
              {description = "open nemo", group = "application"}),
